...
## Complete Syllabus: Data Analysis Learning Path
...
### 3. Data Structures
   - Lists
     ...
     - List Methods (Append, Extend, Remove, Pop, Insert)
...
### 4. Functions and Modules
   ...
   - Scope and Namespaces
     ...
     - LEGB Rule
   - Built-in Functions
     - Print, Input, Len, Range, Sum, Min, Max
     - Map, Filter, Zip
...
### 10. Pandas - Data Manipulation
   ...
   - Data Cleaning
     - Handling Missing Data (NaN, Null)
     - Removing Duplicates
